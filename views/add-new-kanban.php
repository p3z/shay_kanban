...
?>
<main style ="border: 2px solid red;" class="wp-content main-content position-relative max-height-vh-100 h-100 border-radius-lg">
<!-- Navbar -->
...
<div class="container-fluid py-4">
    ...
    <form class="pws-hide user-profile-form" role="form" method="POST" action="<?php echo esc_url(admin_url('admin-post.php')); ?>"  >
            <?php //wp_nonce_field('update_user_info_365_bruh', 'token', false); ?>
            <input type="hidden" name="action" value="update_user_account">
            
            <div class="row">
                <div class="col-6">
                    <div class="input-group pws-input-group input-group-outline">
                        <label class="" for="kanban_name">Kanban board name</label>
                        <input class="" type="text" name="kanban_name" id="kanban_name" value="">
                    </div>
                ...
                <div class="col-6">
                    <div class="input-group pws-input-group input-group-outline">
                            <label class="pws-label" for="num_cols">Number of starting columns</label>
                            <input class="js-num_cols pws-input " type="number" step="1" min="1" max="30" name="num_cols" id="last_name" value="1">
                    </div>
                </div>
            </div>
...
<div style ="border: 2px solid pink;" class="fixed-plugin">
        ...
        column_qty_input.onchange = (e) => {
            ...
            for(let i = 1; i <= num_cols; i++){
                let new_col = PwsHtmlBuilder.create_elements("div", ["col-12"])[0];
                    ...
                    let new_input = PwsHtmlBuilder.create_elements("input")[0];
                    let attr_map = {
                        "type": "text",
                        "name": `column_title_${i}`,
                        "placeholder": `Column ${i} name`
                    }
